...
class SeleniumWrappers(BaseTest):
    ...
    def clear_element_text(self, element_id):
        ...
        self.logger.info("Text field" + element_id + "is cleared ")
        return self
    ...
    def assert_two_values(self, actual_text, expected_text):
        ...
        try:
                ...
                self.logger.info("Validation PASSED: Actual: {} and Expected: {}".format(actual_text,
                                                                                              expected_text))

        except AssertionError:
            
                self.logger.error("Validation FAILED: Actual: {} and Expected: {}".format(actual_text,
                                                                                              expected_text))
    ...
    def get_element(self, element_id, element_type="id", element_index=0):
        ...
        try:
            ...
            self.logger.error("Cannot find element - Type: %s, Name: %s",
    ...
    def select_checkbox(self, element_id, element_type="id"):
        self.logger.info("Selecting checkbox '%s'." % element_id)
        element = self.get_element(element_id=element_id, element_type=element_type)
        element.click()
    ...
    def unselect_checkbox(self, element_id, element_type="id"):
        ...
        self.logger.info("Un-selecting checkbox '%s'." % element_id)
        element = self.get_element(element_id=element_id, element_type=element_type)
